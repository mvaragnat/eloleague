...
Rails.application.config.x.stats.min_matchup_players = [Rails.application.config.x.stats.min_players - 4, 2].max
Rails.application.config.x.stats.min_matchup_games = [Rails.application.config.x.stats.min_games - 4, 5].max
